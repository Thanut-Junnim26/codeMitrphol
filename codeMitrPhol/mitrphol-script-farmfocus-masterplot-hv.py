...
def step_JoinLastYearWithHarvest(df_lastyear, df_harvest):
    ...
    df_lastyear = df_lastyear.merge(
        df_harvest, left_on='plot_id', right_on='plot_id', how='left')
...
def onGetArgs():
    ...
    a['PATH_S3_OUTPUT_MASTERPLOT_HV'] = "s3://mitrphol-farmfocus-prod-553463144000/master/plot_hv/"
...
def main():
    ...
    dff = dff.rename(columns={
        ...
        'zone_id_left': 'zone_id',
        'sub_zone_id_left': 'sub_zone_id',
